...
var Ocean = function ( renderer, options ) {
...
Ocean.prototype.generateMesh = function () {
	...
	let tempMaterialOcean = new THREE.MeshStandardMaterial({ roughness: 0.7,
		color: 0xffffff,
		bumpScale: 0.002,
		metalness: 0.2
	})
	...
	// this.oceanMesh = new Mesh( geometry, tempMaterialOcean );
